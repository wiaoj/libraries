...
internal static partial class RateLimitingLogsExtensions {
    [LoggerMessage(
        ...
        Message = "[RateLimit] Request allowed. Key: '{Key}', Algorithm: {Algorithm}, Cost: {Cost}, Remaining: {Remaining}")]
    ...
    [LoggerMessage(
        ...
        Message = "[RateLimit] Request denied. Key: '{Key}', Algorithm: {Algorithm}, Cost: {Cost}, RetryAfter: {RetryAfterSeconds:F3}s, Remaining: {Remaining}")]
    ...
    [LoggerMessage(
        ...
        Message = "[RateLimit] Request queued for traffic shaping. Key: '{Key}', Algorithm: {Algorithm}, WaitDuration: {WaitDurationMs:F2}ms, Cost: {Cost}")]
    ...
    [LoggerMessage(
        EventId = 1004,
        Level = LogLevel.Debug,
        Message = "[RateLimit] Queued request turn arrived and released. Key: '{Key}', Algorithm: {Algorithm}, Waited: {ElapsedWaitMs:F2}ms")]
    ...
    [LoggerMessage(
        ...
        Message = "[RateLimit] Speculative increment rolled back. Key: '{Key}', Algorithm: {Algorithm}, Cost: {Cost}, Reason: '{Reason}'")]
    ...
    [LoggerMessage(
        EventId = 1006,
        Level = LogLevel.Warning,
        Message = "[RateLimit] Queued request wait cancelled; reservation rolled back. Key: '{Key}', Algorithm: {Algorithm}, Cost: {Cost}")]
    ...
    [LoggerMessage(
        ...
        Message = "[RateLimit] Storage failure occurred while evaluating key '{Key}' on {Algorithm}. Executing Fail-Open fallback (Request Allowed).")]
    ...
    [LoggerMessage(
        EventId = 1008,
        Level = LogLevel.Debug,
        Message = "[RateLimit] Request short-circuited by local negative cache. Key: '{Key}', Algorithm: {Algorithm}, RetryAfter: {RetryAfterSeconds:F3}s")]
