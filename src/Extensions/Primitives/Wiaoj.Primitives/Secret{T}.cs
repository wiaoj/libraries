...
public readonly unsafe struct Secret<T> :
    ...
    /// <summary>
    /// Gets the factory instance used to access secret data generators that follow 
    /// industry-standard cryptographic configurations.
    /// </summary>
    /// <value>
    /// A <see cref="SecretFactory"/> instance that serves as a root for fluent extensions.
    /// </value>
    /// <example>
    /// <code>
    /// // Generates a 256-bit random AES key stored in secure memory
    /// using var key = Secret.Factory.Aes256Key();
    /// 
    /// // Generates a cryptographically secure salt
    /// using var salt = Secret.Factory.SecureSalt();
    /// </code>
    /// </example>
    public static SecretFactory Factory { get; } = new();
