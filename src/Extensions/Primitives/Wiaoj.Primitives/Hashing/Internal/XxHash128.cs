...
namespace Wiaoj.Primitives.Hashing.Internal
{
    ...
    [SkipLocalsInit]
#endif
    internal sealed unsafe class XxHash128Core : NonCryptographicHashAlgorithm
    {
        ...
        private XxHash128Core(State state) : base(HashLengthInBytes)
        {
            _state = state;
        }
        ...
        public XxHash128Core Clone() => new(_state);
        ...
        private static Hash128 HashLength0To16(byte* source, uint length, ulong seed)
        {
            ...
            return new Hash128(XxHash64Core.Avalanche(seed ^ BitFlipL), XxHash64Core.Avalanche(seed ^ BitFlipH));
        }
        ...
        private static Hash128 HashLength1To3(byte* source, uint length, ulong seed)
        {
            ...
            return new Hash128(XxHash64Core.Avalanche(keyedLo), XxHash64Core.Avalanche(keyedHi));
        }
