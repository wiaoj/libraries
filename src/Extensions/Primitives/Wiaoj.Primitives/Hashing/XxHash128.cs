...
public readonly struct XxHash128
    ...
    static XxHash128 IParsable<XxHash128>.Parse(string s, IFormatProvider? provider) {
        return Parse(s);
    }

    static bool IParsable<XxHash128>.TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, out XxHash128 result) {
        return TryParse(s, out result);
    }

    static XxHash128 ISpanParsable<XxHash128>.Parse(ReadOnlySpan<char> s, IFormatProvider? provider) {
        return Parse(s);
    }

    static bool ISpanParsable<XxHash128>.TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out XxHash128 result) {
        return TryParse(s, out result);
    }

    static XxHash128 IUtf8SpanParsable<XxHash128>.Parse(ReadOnlySpan<byte> utf8Text, IFormatProvider? provider) {
        return Parse(utf8Text);
    }

    static bool IUtf8SpanParsable<XxHash128>.TryParse(ReadOnlySpan<byte> utf8Text, IFormatProvider? provider, out XxHash128 result) {
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash for the contents of a secure <see cref="Secret{Byte}"/> using the specified seed.
    /// </summary>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XxHash128 Compute(Secret<byte> secret, long seed) {
        Preca.ThrowIfNull(secret);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [SkipLocalsInit]
    public static XxHash128 Compute(ReadOnlySpan<byte> data, long seed) {
        return new(XxHash128Core.HashToUInt128(data, seed));
    }
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash of a character span using UTF-8 encoding and the specified seed.
    /// </summary>
    /// <param name="chars">The character span to hash.</param>
    /// <param name="seed">The seed to initialize the hash computation with.</param>
    /// <returns>A new <see cref="XxHash128"/> instance containing the 128-bit digest.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XxHash128 Compute(ReadOnlySpan<char> chars, long seed) {
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash of a character span using the specified encoding and seed.
    /// </summary>
    /// <param name="chars">The character span to hash.</param>
    /// <param name="encoding">The encoding used to convert the characters to bytes before hashing.</param>
    /// <param name="seed">The seed to initialize the hash computation with.</param>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [SkipLocalsInit]
    public static XxHash128 Compute(ReadOnlySpan<char> chars, Encoding encoding, long seed) {
        Preca.ThrowIfNull(encoding);
        int maxByteCount = encoding.GetMaxByteCount(chars.Length);
        using ValueBuffer<byte> buffer = new(maxByteCount, stackalloc byte[1024]);
        int bytesWritten = encoding.GetBytes(chars, buffer.Span);
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash for the contents of a secure <see cref="Secret{Char}"/> using the specified encoding and seed.
    /// </summary>
    /// <param name="secret">The secret character data to hash.</param>
    /// <param name="encoding">The encoding used to convert the characters to bytes before hashing.</param>
    /// <param name="seed">The seed to initialize the hash computation with.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XxHash128 Compute(Secret<char> secret, Encoding encoding, long seed) {
        Preca.ThrowIfNull(secret);
        Preca.ThrowIfNull(encoding);
        return secret.Expose(chars => {
            int maxByteCount = encoding.GetMaxByteCount(chars.Length);
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash for the contents of a secure <see cref="Secret{Char}"/> using UTF-8 encoding and the specified seed.
    /// </summary>
    /// <param name="secret">The secret character data to hash.</param>
    /// <param name="seed">The seed to initialize the hash computation with.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XxHash128 Compute(Secret<char> secret, long seed) {
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash of a string using the specified encoding and seed.
    /// </summary>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    [SkipLocalsInit]
    public static XxHash128 Compute(string text, Encoding encoding, long seed) {
        Preca.ThrowIfNull(text);
        Preca.ThrowIfNull(encoding);
        int maxByteCount = encoding.GetMaxByteCount(text.Length);
        using ValueBuffer<byte> buffer = new(maxByteCount, stackalloc byte[1024]);
    ...
    /// <summary>
    /// Computes the XXHash3-128 hash of a string using UTF-8 encoding and the specified seed.
    /// </summary>
    /// <param name="text">The string to hash.</param>
    /// <param name="seed">The seed to initialize the hash computation with.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static XxHash128 Compute(string text, long seed) {
    ...
    /// <summary>
    /// Deconstructs the <see cref="XxHash128"/> struct into its low and high 64-bit unsigned integer components.
    /// </summary>
    /// <param name="low">The lower 64 bits of the 128-bit hash value.</param>
    /// <param name="high">The upper 64 bits of the 128-bit hash value.</param>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly void Deconstruct(out ulong low, out ulong high) {
        low = (ulong)this._value;
        high = (ulong)(this._value >> 64);
    }
    ...
    /// <inheritdoc/>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(XxHash128 other) {
    ...
    private sealed class XxHash128OrdinalComparer : IEqualityComparer<XxHash128>, IAlternateEqualityComparer<ReadOnlySpan<char>, XxHash128> {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(XxHash128 x, XxHash128 y) {
            return x.Equals(y);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public int GetHashCode(XxHash128 obj) {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public XxHash128 Create(ReadOnlySpan<char> alternate) {
            return XxHash128.Parse(alternate);
        }
    }
...
public static partial class XxHash128Extensions {
    extension(XxHash128) {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueTask<XxHash128> ComputeAsync(Stream stream) {
        ...
        /// <param name="seed">The seed to initialize the hash computation with.</param>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ValueTask<XxHash128> ComputeAsync(Stream stream, long seed) {
        ...
        /// <param name="seed">The seed to initialize the hash computation with.</param>
        public static async ValueTask<XxHash128> ComputeAsync(
            Stream stream, CancellationToken cancellationToken, long seed) {
            Preca.ThrowIfNull(stream);
            if(stream.CanSeek) stream.Position = 0;

            XxHash128Core hasher = new(seed);
            byte[] rented = ArrayPool<byte>.Shared.Rent(81_920); // 80 KB chunks
