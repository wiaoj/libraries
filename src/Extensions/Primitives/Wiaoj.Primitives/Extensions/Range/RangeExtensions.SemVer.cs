...
public static partial class RangeExtensions {
    ...
    /// </summary>
    public static IEnumerable<SemVer> FilterCompatible(this Range<SemVer> range, params IEnumerable<SemVer> versions) {
    ...
    /// </summary>
    public static SemVer? GetLatestCompatible(this Range<SemVer> range, params IEnumerable<SemVer> versions) {
        SemVer? latest = null;
