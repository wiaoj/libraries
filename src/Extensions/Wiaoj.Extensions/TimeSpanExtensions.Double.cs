...
public static partial class TimeSpanExtensions {
    /// <param name="value">The double value to convert, representing milliseconds.</param>
    /// <exception cref="PrecaArgumentOutOfRangeException">Thrown if <paramref name="value"/> is negative.</exception>
    extension(double value) {
        /// <summary>
        /// Converts a <see cref="double"/> value to a <see cref="TimeSpan"/> representing milliseconds.
        /// </summary>
        ...
        /// <summary>
        /// Converts a <see cref="double"/> value to a <see cref="TimeSpan"/> representing seconds.
        /// </summary> 
        ...
        /// <summary>
        /// Converts a <see cref="double"/> value to a <see cref="TimeSpan"/> representing minutes.
        /// </summary> 
        ...
        /// <summary>
        /// Converts a <see cref="double"/> value to a <see cref="TimeSpan"/> representing hours.
        /// </summary> 
        ...
        /// <summary>
        /// Converts a <see cref="double"/> value to a <see cref="TimeSpan"/> representing days.
        /// </summary> 
