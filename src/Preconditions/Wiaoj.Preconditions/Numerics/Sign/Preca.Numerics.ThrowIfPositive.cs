...
public static partial class Preca {
    ...
    /// <exception cref="Exception">Thrown when <paramref name="argument"/> is greater than zero, using the exception created by <paramref name="exceptionFactory"/>.</exception>
    [DebuggerStepThrough, StackTraceHidden]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void ThrowIfPositive<T, TState, TException>(T argument,
