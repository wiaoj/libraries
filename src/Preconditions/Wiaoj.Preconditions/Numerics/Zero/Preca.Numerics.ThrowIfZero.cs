...
public static partial class Preca {
    ...
    /// <exception cref="Exception">Thrown when <paramref name="argument"/> equals zero, using the exception created by <paramref name="exceptionFactory"/>.</exception>
    [DebuggerStepThrough, StackTraceHidden]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void ThrowIfZero<T, TState, TException>(
        T argument,
