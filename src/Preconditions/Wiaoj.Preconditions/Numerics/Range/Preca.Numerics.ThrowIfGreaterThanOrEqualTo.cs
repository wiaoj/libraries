...
public static partial class Preca {
    ...
    /// <exception cref="PrecaArgumentOutOfRangeException">Thrown when <paramref name="argument"/> is greater than or equal to <paramref name="limit"/>.</exception>
    [DebuggerStepThrough, StackTraceHidden]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void ThrowIfGreaterThanOrEqualTo<T>(T argument, T limit,
    ...
    /// <summary>
    /// Validates that the specified numeric value is strictly less than the limit, throwing a specific exception type.
    /// </summary>
    /// <typeparam name="T">The numeric type to validate. Must implement <see cref="IComparable{T}"/>.</typeparam>
    ...
    /// <param name="limit">The exclusive upper bound limit.</param>
    /// <param name="paramName">The name of the parameter being validated. This parameter is automatically populated by the compiler.</param>
    /// <exception cref="Exception">Thrown when <paramref name="argument"/> is greater than or equal to <paramref name="limit"/>.</exception>
    [DebuggerStepThrough, StackTraceHidden]
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static void ThrowIfGreaterThanOrEqualTo<T, TException>(T argument, T limit,
                                                         [CallerArgumentExpression(nameof(argument))] string? paramName = null)
